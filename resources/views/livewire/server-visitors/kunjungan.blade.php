            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <ul class="nav nav-pills" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link {{ $activeTab == 'Masih-Berkunjung' ? 'active' : '' }}" wire:click="setActiveTab('Masih-Berkunjung')" data-bs-toggle="tab" href="#Masih-Berkunjung" role="tab" aria-selected="false">Masih Berkunjung</a>
                        </li>
                    </ul>
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        ...
                        <a href="/user-permintaan/create" class="btn btn-primary ms-2" >
